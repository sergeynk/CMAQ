...
#> Set Start and End Days for looping
 ...
 set END_DATE   = "2019-05-22"     #> ending date    (December 31, 2016)
...
set ICpath    = /work/MOD3DEV/tskipper/methane/cmaq/icbc             #> initial conditions input directory
set BCpath    = /work/MOD3EVAL/nsu/methane/icbc/2019             #> boundary conditions input directory
set EMISpath  = /work/MOD3EVAL/nsu/methane/emissions/2019/premerged/12US1
set PREMRGpath = $EMISpath 
set IN_PTpath = $EMISpath
set STKGRPpath = $EMISpath
...
# =====================================================================
  ...
  if ($NEW_START == true || $NEW_START == TRUE ) then
     setenv ICFILE CCTM_CGRID_v54_cracmm1_aq_WR705_2018gc2_STAGE_EM_2018_12US1_20181130_only_ECH4_m3tshift_${YESTERDAY}.nc
  ...
  set BCFILE = BCON_CONC_12US1_CMAQv54_2019_108NHEMI_CRACCM1_FRMEQ_regrid_${YYYYMM}_ECH4.nc
...
# setenv LUFRAC_CRO  $METpath/LUFRAC_CRO.$GRID_NAME.${NZ}L.$YYMMDD
  ...
  set sector = emi_ch4_1A_Combustion_Mobile
  set EMISfile = ${sector}_${GRID_NAME}_${aveday_Y}.nc
  ...
  set sector = emi_ch4_1A_Combustion_Stationary
  set EMISfile = ${sector}_${GRID_NAME}_${aveday_Y}.nc
  ...
  set sector = emi_ch4_1B1a_Abandoned_Coal
  set EMISfile = ${sector}_${GRID_NAME}_${aveday_Y}.nc
  ...
  set sector = emi_ch4_1B1a_Surface_Coal
  set EMISfile = ${sector}_${GRID_NAME}_${aveday_Y}.nc
  ...
  set sector = emi_ch4_1B1a_Underground_Coal
  set EMISfile = ${sector}_${GRID_NAME}_${aveday_Y}.nc
  ...
  set sector = emi_ch4_1B2ab_Abandoned_Oil_Gas
  set EMISfile = ${sector}_${GRID_NAME}_${aveday_Y}.nc
  ...
  set sector = emi_ch4_1B2a_Petroleum_Systems_Exploration
  set EMISfile = ${sector}_${GRID_NAME}_${aveday_Y}.nc
  ...
  set sector = emi_ch4_1B2a_Petroleum_Systems_Production
  set EMISfile = ${sector}_${GRID_NAME}_${aveday_Y}.nc
  ...
  set sector = emi_ch4_1B2a_Petroleum_Systems_Refining
  set EMISfile = ${sector}_${GRID_NAME}_${aveday_Y}.nc
  setenv GR_EMIS_009 ${EMISpath}/${sector}/${EMISfile}
  setenv GR_EMIS_LAB_009 G_${sector}
  setenv GR_EM_SYM_DATE_009 T # To change default behaviour please see Users Guide for EMIS_SYM_DATE

  set sector = emi_ch4_1B2a_Petroleum_Systems_Transport
  set EMISfile = ${sector}_${GRID_NAME}_${aveday_Y}.nc
  setenv GR_EMIS_010 ${EMISpath}/${sector}/${EMISfile}
  setenv GR_EMIS_LAB_010 G_${sector}
  setenv GR_EM_SYM_DATE_010 T # To change default behaviour please see Users Guide for EMIS_SYM_DATE

  set sector = emi_ch4_1B2b_Natural_Gas_Distribution
  set EMISfile = ${sector}_${GRID_NAME}_${aveday_Y}.nc
  setenv GR_EMIS_011 ${EMISpath}/${sector}/${EMISfile}
  setenv GR_EMIS_LAB_011 G_${sector}
  setenv GR_EM_SYM_DATE_011 T # To change default behaviour please see Users Guide for EMIS_SYM_DATE

  set sector = emi_ch4_1B2b_Natural_Gas_Exploration
  set EMISfile = ${sector}_${GRID_NAME}_${aveday_Y}.nc
  setenv GR_EMIS_012 ${EMISpath}/${sector}/${EMISfile}
  setenv GR_EMIS_LAB_012 G_${sector}
  setenv GR_EM_SYM_DATE_012 T # To change default behaviour please see Users Guide for EMIS_SYM_DATE

  set sector = emi_ch4_1B2b_Natural_Gas_Processing
  set EMISfile = ${sector}_${GRID_NAME}_${aveday_Y}.nc
  setenv GR_EMIS_013 ${EMISpath}/${sector}/${EMISfile}
  setenv GR_EMIS_LAB_013 G_${sector}
  setenv GR_EM_SYM_DATE_013 T # To change default behaviour please see Users Guide for EMIS_SYM_DATE

  set sector = emi_ch4_1B2b_Natural_Gas_Production
  set EMISfile = ${sector}_${GRID_NAME}_${aveday_Y}.nc
  setenv GR_EMIS_014 ${EMISpath}/${sector}/${EMISfile}
  setenv GR_EMIS_LAB_014 G_${sector}
  setenv GR_EM_SYM_DATE_014 T # To change default behaviour please see Users Guide for EMIS_SYM_DATE

  set sector = emi_ch4_1B2b_Natural_Gas_TransmissionStorage
  set EMISfile = ${sector}_${GRID_NAME}_${aveday_Y}.nc
  setenv GR_EMIS_015 ${EMISpath}/${sector}/${EMISfile}
  setenv GR_EMIS_LAB_015 G_${sector}
  setenv GR_EM_SYM_DATE_015 T # To change default behaviour please see Users Guide for EMIS_SYM_DATE

  set sector = emi_ch4_2B8_Industry_Petrochemical
  set EMISfile = ${sector}_${GRID_NAME}_${aveday_Y}.nc
  setenv GR_EMIS_016 ${EMISpath}/${sector}/${EMISfile}
  setenv GR_EMIS_LAB_016 G_${sector}
  setenv GR_EM_SYM_DATE_016 T # To change default behaviour please see Users Guide for EMIS_SYM_DATE

  set sector = emi_ch4_2C2_Industry_Ferroalloy
  set EMISfile = ${sector}_${GRID_NAME}_${aveday_Y}.nc
  setenv GR_EMIS_017 ${EMISpath}/${sector}/${EMISfile}
  setenv GR_EMIS_LAB_017 G_${sector}
  setenv GR_EM_SYM_DATE_017 T # To change default behaviour please see Users Guide for EMIS_SYM_DATE

  set sector = emi_ch4_3A_Enteric_Fermentation
  set EMISfile = ${sector}_${GRID_NAME}_${aveday_Y}.nc
  setenv GR_EMIS_018 ${EMISpath}/${sector}/${EMISfile}
  setenv GR_EMIS_LAB_018 G_${sector}
  setenv GR_EM_SYM_DATE_018 T # To change default behaviour please see Users Guide for EMIS_SYM_DATE

  set sector = emi_ch4_3B_Manure_Management
  set EMISfile = ${sector}_${GRID_NAME}_${aveday_Y}.nc
  setenv GR_EMIS_019 ${EMISpath}/${sector}/${EMISfile}
  setenv GR_EMIS_LAB_019 G_${sector}
  setenv GR_EM_SYM_DATE_019 T # To change default behaviour please see Users Guide for EMIS_SYM_DATE

  set sector = emi_ch4_3C_Rice_Cultivation
  set EMISfile = ${sector}_${GRID_NAME}_${aveday_Y}.nc
  setenv GR_EMIS_020 ${EMISpath}/${sector}/${EMISfile}
  setenv GR_EMIS_LAB_020 G_${sector}
  setenv GR_EM_SYM_DATE_020 T # To change default behaviour please see Users Guide for EMIS_SYM_DATE

  set sector = emi_ch4_3F_Field_Burning 
  set EMISfile = ${sector}_${GRID_NAME}_${aveday_Y}.nc
  setenv GR_EMIS_021 ${EMISpath}/${sector}/${EMISfile}
  setenv GR_EMIS_LAB_021 G_${sector}
  setenv GR_EM_SYM_DATE_021 T # To change default behaviour please see Users Guide for EMIS_SYM_DATE

  set sector = emi_ch4_5A1_Landfills_Industrial
  set EMISfile = ${sector}_${GRID_NAME}_${aveday_Y}.nc
  setenv GR_EMIS_022 ${EMISpath}/${sector}/${EMISfile}
  setenv GR_EMIS_LAB_022 G_${sector}
  setenv GR_EM_SYM_DATE_022 T # To change default behaviour please see Users Guide for EMIS_SYM_DATE

  set sector = emi_ch4_5A1_Landfills_MSW
  set EMISfile = ${sector}_${GRID_NAME}_${aveday_Y}.nc
  setenv GR_EMIS_023 ${EMISpath}/${sector}/${EMISfile}
  setenv GR_EMIS_LAB_023 G_${sector}
  setenv GR_EM_SYM_DATE_023 T # To change default behaviour please see Users Guide for EMIS_SYM_DATE
 
  set sector = emi_ch4_5B1_Composting
  set EMISfile = ${sector}_${GRID_NAME}_${aveday_Y}.nc
  setenv GR_EMIS_024 ${EMISpath}/${sector}/${EMISfile}
  setenv GR_EMIS_LAB_024 G_${sector}
  setenv GR_EM_SYM_DATE_024 T # To change default behaviour please see Users Guide for EMIS_SYM_DATE
 
  set sector = emi_ch4_5D_Wastewater_Treatment_Domestic
  set EMISfile = ${sector}_${GRID_NAME}_${aveday_Y}.nc
  setenv GR_EMIS_025 ${EMISpath}/${sector}/${EMISfile}
  setenv GR_EMIS_LAB_025 G_${sector}
  setenv GR_EM_SYM_DATE_025 T # To change default behaviour please see Users Guide for EMIS_SYM_DATE
 
  set sector = emi_ch4_5D_Wastewater_Treatment_Industrial
  set EMISfile = ${sector}_${GRID_NAME}_${aveday_Y}.nc
  setenv GR_EMIS_026 ${EMISpath}/${sector}/${EMISfile}
  setenv GR_EMIS_LAB_026 G_${sector}
  setenv GR_EM_SYM_DATE_026 T # To change default behaviour please see Users Guide for EMIS_SYM_DATE

  set sector = emi_ch4_Supp_1B2b_PostMeter
  set EMISfile = ${sector}_${GRID_NAME}_${aveday_Y}.nc
  setenv GR_EMIS_027 ${EMISpath}/${sector}/${EMISfile}
  setenv GR_EMIS_LAB_027 G_${sector}
  setenv GR_EM_SYM_DATE_027 T # To change default behaviour please see Users Guide for EMIS_SYM_DATE
